   ...
   <br><br><br><br><center style="color:red">Confirmation To Delte Your Account</center><br>
    <form>
      <table align="center" style="font-size: 20px; text-align:justify">
       ...
       <tr>
         <td><input type="submit" value="Yes" formaction="/donor/unregisterdata" formmethod="POST"/>&nbsp; &nbsp;
             <input type="submit" value="No" formaction="/donor/unregister" formmethod="GET"/></td>
       </tr>
     </table>
     </form>
</body>
