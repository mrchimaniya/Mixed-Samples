...
<body>
  <jsp:include page="/WEB-INF/view/login.jsp"/>
   <br><center>You Can Update Your Data Here</center><br>
 <form method="POST" action="/updateuserdata">
   ...
   <table align="center" style="font-size:20; text-align: justify;">
     ...
     <tr>
       ...
       <td>
           <span style="color:red">${donor.getAge() }</span>
           <input type="number" min="17" max="65" name="age"/></td>
     ...
     <tr>
       ...
       <td>${donor.getPhone() }
           <input type="hidden" name="phone" value="${donor.getPhone() }" /></td>
     </tr>
     <tr>
