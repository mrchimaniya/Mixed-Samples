...
//	request for operations
	...
	@GetMapping("/searchbloodbyarearequest")  
	public String findBloodByArea(@RequestParam String bloodGroup, Model model)
	{  
		List<Donor> donorsRecord = donorService.searchBloodByArea(bloodGroup);
		...
		return "donorrecordtable";
	}
	
	@GetMapping("/searchbynearestbloodbankrequest")
	public String findBloodByNearestHospital(@RequestParam String bloodGroup, @RequestParam String nearestBloodBank, Model model)
	{   
		List<Donor> donorsRecord = donorService.searchBloodByNearestHospital(bloodGroup,nearestBloodBank);
	      if(donorsRecord.isEmpty())
		  {
			  model.addAttribute("status","!Opps No Donors Are Available");
			  return "status";
		  }
		model.addAttribute("bloodFilter","<span style='color:red'>"+bloodGroup+"</span>   Donors Nearby "+nearestBloodBank);
		model.addAttribute("donorsRecord",donorsRecord);
		return "donorrecordtable";
	}
